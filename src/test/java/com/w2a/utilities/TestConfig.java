...
public class TestConfig{
	...
	public static String from = "maheshmaddala1987@gmail.com";
	public static String password = "maheshreddy1";
	public static String[] to ={"mah.maddala@gmail.com","maheshreddy.maddala@gmail.com"};
